...
"""
struct Query{W<:World,TS<:Tuple,SM<:Tuple,EX,OPT,REG,N,M,R<:Tuple,QS<:Tuple}
...
@generated function _get_columns(
    ...
    table::_Table,
) where {W<:World,TS<:Tuple,SM<:Tuple,EX,OPT,REG,N,M,R<:Tuple,QS}
...
) where {W<:World,CT<:Tuple,SM<:Tuple,EX<:Val,OPT,REG,N,M,R<:Tuple,QS}
