...
# Arguments
  ...
  - `components::Tuple`: A tuple of components to add. Either default values like `(Position(0, 0), Velocity(1, 1))`, types like `(Position, Velocity)`, or relation pairs like `(ChildOf => parent,)`.
