...
- Built-in [GPU integration](https://ark-ecs.github.io/Ark.jl/stable/components.html#GPU-Storages) for [maximal performance](https://ark-ecs.github.io/Ark.jl/stable/benchmarks.html#CPU-vs.-GPU-Storage).
